...
unsigned char led[11]={0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90, 0x7f};
...
void main()
{
   ...
   TH0 = 0 ;      // Giá tr? cho TH0
	...
	while(1)
	{
		...
		{
			ET0 = 1;
			if(check) hienthi(myDatetime.hour, myDatetime.minute, myDatetime.second);
			else hienthi(myDatetime.day, myDatetime.month, myDatetime.year);
		}
	}
}